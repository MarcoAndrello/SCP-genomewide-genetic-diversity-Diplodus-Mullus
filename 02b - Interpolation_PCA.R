...
mape_nn %>% rowMeans %>% barplot(xlab="PCA axis",names.arg=c(1:17), main="MAPE Nearest neighbor",ylim=c(0,1600))
mape_idw %>% rowMeans %>% barplot(xlab="PCA axis",names.arg=c(1:17), main="MAPE inverse distance weighing",ylim=c(0,1600))
