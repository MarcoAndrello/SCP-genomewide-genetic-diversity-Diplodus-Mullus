...
etopo1 <- rast(paste0(getwd(),"/data/ETOPO1_Med/ETOPO1-ice-Mediterranean.tif"))
...
# Read Fishmed data
# The "FishMed_2species_1980.csv" file has been generated by subsetting the two studied species from the original "Observed_grid_1980.csv" file of Albouy et al (2015)
# See: https://doi.org/10.1890/14-2279.1
