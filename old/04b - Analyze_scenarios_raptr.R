...
save(jaccard_distance, pvalue, file=paste0(getwd(),"/Results/Jaccard_distance_raptr_",species,".RData"))
# Plot a tree showing distances between solutions
load(paste0(getwd(),"/results/Jaccard_distance_raptr_",species,".RData"))
...
save(plots,file=paste0(getwd(),"/Results/Plots_space_held_",species,".RData"))
load(paste0(getwd(),"/Results/Plots_space_held_",species,".RData"))
